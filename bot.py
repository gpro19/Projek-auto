...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Halo! datang di bot keanggotaan kami.\n\n"
...
async def subscribe(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        reply_markup = Inlinamat datang di bot keanggotaan kami.\n\n"
        "Untuk mendapatkan akses ke grup eksklusif kami, silakan ketik /subscribe.\n"
        "Jika Anda sudah membayar, ketik /status untuk mendapatkan link grup Anda."
    )
...
def main():
    ...
    # Jalankan Flask dan bot dalam satu event loop
    loop = asyncio.get_event_loop()

    try:
        # Jalankan setup webhook dan scheduler
        loop.run_until_complete(setup_bot())

        # Jalankan Flask app secara blocking
