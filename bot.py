...
# ---------------- STARTUP ----------------
async def main():
    """Fungsi utama untuk menjalankan bot, Flask, dan scheduler dalam satu loop."""
    ...
    # Atur webhook dan jalankan scheduler
    ...
    # Jalankan bot
    await application.run_webhook(listen="0.0.0.0", port=8000, webhook_url=WEBHOOK_URL)
